...
/* Smarty version 3.1.43, created on 2022-12-11 20:24:14
  from 'C:\wamp64\www\prestashop\themes\blck\templates\checkout\_partials\order-confirmation-table.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.43',
  'unifunc' => 'content_63962e5ee44d28_85162297',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '8c515ceffc7b35df1b1d19c1ec986f35e94127ae' => 
    array (
      0 => 'C:\\wamp64\\www\\prestashop\\themes\\blck\\templates\\checkout\\_partials\\order-confirmation-table.tpl',
      1 => 1670692123,
      2 => 'file',
    ),
  ),
...
function content_63962e5ee44d28_85162297 (Smarty_Internal_Template $_smarty_tpl) {
...
<div id="order-items" class="">
  <div class="row">
      <?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_158227117663962e5ee00602_78149506', 'order_items_table_head');
?>
  ...
  <div class="order-confirmation-table">
      ...
      <?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_126606209963962e5ee04f54_45931303', 'order_confirmation_table');
?>
...
class Block_158227117663962e5ee00602_78149506 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'order_items_table_head' => 
  array (
    0 => 'Block_158227117663962e5ee00602_78149506',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>

        <h3 class="table__title-head col-md-6 col-12"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Order items','d'=>'Shop.Theme.Checkout'),$_smarty_tpl ) );?>
</h3>
        <h3 class="table__title-head col-md-2 text-md-center _desktop-title"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Unit price','d'=>'Shop.Theme.Checkout'),$_smarty_tpl ) );?>
</h3>
        <h3 class="table__title-head col-md-2 text-md-center _desktop-title"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Quantity','d'=>'Shop.Theme.Checkout'),$_smarty_tpl ) );?>
</h3>
        <h3 class="table__title-head col-md-2 text-md-center _desktop-title"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Total products','d'=>'Shop.Theme.Checkout'),$_smarty_tpl ) );?>
</h3>
      <?php
}
}
...
class Block_126606209963962e5ee04f54_45931303 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'order_confirmation_table' => 
  array (
    0 => 'Block_126606209963962e5ee04f54_45931303',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
              ...
              <div class="col-sm-6 col-12 qty">
                <div class="row">
                  <div class="col-4 text-sm-center text-left"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['price'], ENT_QUOTES, 'UTF-8');?>
</div>
                  <div class="col-4 text-sm-center"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['quantity'], ENT_QUOTES, 'UTF-8');?>
</div>
                  <div class="col-4 text-sm-center text-right bold"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['total'], ENT_QUOTES, 'UTF-8');?>
</div>
                </div>
              </div>
            </div>
...
&nbsp;<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['labels']->value['tax_short'], ENT_QUOTES, 'UTF-8');?>
              ...
              <tr class="total-value font-weight-bold">
                ...
                <td class="text-right"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['totals']->value['total_including_tax']['value'], ENT_QUOTES, 'UTF-8');?>
</td>
              </tr>
            <?php } else { ?>
              <tr class="total-value font-weight-bold">
...
echo htmlspecialchars($_smarty_tpl->tpl_vars['labels']->value['tax_short'], ENT_QUOTES, 'UTF-8');
            ...
            <?php if ($_smarty_tpl->tpl_vars['subtotals']->value['tax']['label'] !== null) {?>
              <tr class="sub taxes">
                  <td class="small"><span class="label"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'%label%:','sprintf'=>array('%label%'=>$_smarty_tpl->tpl_vars['subtotals']->value['tax']['label']),'d'=>'Shop.Theme.Global'),$_smarty_tpl ) );?>
